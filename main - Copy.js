...
function gotResult(error, results){
    ...
    console.log(results);
    var drawn_sketch=document.getElementById("label").innerHTML;
    document.getElementById("label").innerHTML=drawn_sketch+label;
...
function check_sketch(){
    if(drawn_sketch==sketch){
        timer_counter++;
        var old_time = document.getElementById("timer").innerHTML
        document.getElementById("timer").innerHTML= old_timer + timer;
